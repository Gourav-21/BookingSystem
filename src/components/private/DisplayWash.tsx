...
export default function DisplayWash({ onInputChange, formData, setNext }) {
    ...
    useEffect(() => {
        const isValid = formData?.type_of_home && formData?.Should_entire_home_be_washed && formData?.area_size;
        setNext(isValid);
    }, [formData, setNext]);
