...
function RegularCleaning3({ onInputChange, formData, setNext }) {
    ...
    useEffect(() => {
        ...
        setSelectedFloors(formData?.Hvor_mange_etasjer_skal_vaskes || "");
    }, []);
    ...
    return (
        <div className="grid w-full items-center gap-5">
            ...
            <div className="flex flex-col space-y-1.5">
                ...
                <Select onValueChange={e => { onInputChange("Hvor_mange_etasjer_skal_vaskes", e); setSelectedFloors(e); }} value={selectedFloors}>
